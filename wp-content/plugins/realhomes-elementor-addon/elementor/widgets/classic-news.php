...
class RHEA_Classic_News_Section_Widget extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
		...
		wp_register_script(
			'rhea-classic-news-widget',
			RHEA_PLUGIN_URL . 'elementor/js/classic-news-widget.js',
	...
	protected function render() {
		...
		if ( $recent_posts_query->have_posts() ) {
			?>
            <section id="rh-<?php echo $this->get_id(); ?>" class="rhea_ele_property_ajax_target rhea_latest_properties_ajax_classic">
                            ...
                            <article <?php post_class(); ?>>
                                <div class="rhea_post_inner">
                                    ...
                                    <div class="rhea_content_news_classic">
                                        <h4 class="rhea_post_title">
                                            <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                        </h4>
										<?php if ( 'yes' == $settings['show_date'] || 'yes' == $settings['show_author'] ) { ?>
                                            <div class="rhea_post_meta">
												<?php if ( 'yes' == $settings['show_date'] ) { ?>
                                                    <span><?php echo esc_html( $settings['ere_news_on'] ); ?> <span class="date"> <?php the_time( get_option( 'date_format' ) ); ?></span></span>
													<?php
												}
												if ( 'yes' == $settings['show_author'] ) {
													?>
                                                    <span><?php echo esc_html( $settings['ere_news_by'] ); ?> <span class="author-link"><?php the_author() ?></span></span>
												<?php } ?>
                                            </div>
											<?php
										}
										...
										if ( 'yes' == $settings['show_read_more'] ) {
											?>
                                            <a class="rhea_more_details" href="<?php the_permalink() ?>"><?php echo esc_html( $settings['ere_news_read_more'] ); ?>
