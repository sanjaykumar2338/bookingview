...
class RHEA_Schedule_Tour_Form_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'name_field_width',
			[
				'label'     => esc_html__( 'Name Field Label Width', 'realhomes-elementor-addon' ),
		...
		$this->add_control(
			'email_field_width',
			[
				'label'     => esc_html__( 'Email Field Label Width', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'date_field_label',
			[
				'label'   => esc_html__( 'Date and Time Field Label', 'realhomes-elementor-addon' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' =>'',
			]
		);
		...
		$this->add_control(
			'date_field_width',
			[
				'label'     => esc_html__( 'Date and Time Field Label Width', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'message_field_width',
			[
				'label'     => esc_html__( 'Message Field Label Width', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'button_text',
			[
				'label'   => esc_html__( 'Submit Button Label', 'realhomes-elementor-addon' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
                ...
                <form class="rhea-stf-form" id="rhea-stf-form-<?php echo esc_attr( $widget_id ); ?>" method="post"
                    ...
                    <div class="rhea-stf-form-fields">
                        <div class="rhea-stf-form-field rhea-stf-form-name-field">
							<?php
							$name_field_label = esc_html__( 'Hey my name is', 'realhomes-elementor-addon' );
                        ...
                        <div class="rhea-stf-form-field rhea-stf-form-email-field">
							<?php
							$email_field_label = esc_html__( 'and my email id is', 'realhomes-elementor-addon' );
                        ...
                        <div class="rhea-stf-form-field rhea-stf-form-date-field" id="date-field-<?php echo esc_attr( $widget_id ); ?>-wrapper">
							<?php
							$date_field_label = esc_html__( 'I would like to schedule a tour at date and time', 'realhomes-elementor-addon' );
                        ...
                        <div class="rhea-stf-form-field rhea-stf-form-message-field">
							<?php
							$message_field_label = esc_html__( 'I would like to discuss about', 'realhomes-elementor-addon' );
