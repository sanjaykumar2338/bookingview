...
class RHEA_Properties_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'description' => esc_html__( 'Number of columns will be reduced automatically if parent container has insufficient width.', 'realhomes-elementor-addon' ) . '<br>' .
					esc_html__( '* To apply this, make sure "Style -> Property Width" field is empty.', 'realhomes-elementor-addon' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => '33.333%',
				'options'     => array(
				...
				'selectors'   => [
					'{{WRAPPER}} .rh_properties_element .wrapper_properties_ele' => 'width: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'ere_enable_property_types',
			[
				'label'        => esc_html__( 'Show Property Types', 'realhomes-elementor-addon' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'realhomes-elementor-addon' ),
				'label_off'    => esc_html__( 'No', 'realhomes-elementor-addon' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label'        => esc_html__( 'Show Property Status with Price', 'realhomes-elementor-addon' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'realhomes-elementor-addon' ),
				'label_off'    => esc_html__( 'No', 'realhomes-elementor-addon' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'rhea_show_old_price',
			[
				'label'        => esc_html__( 'Show Old Price', 'realhomes-elementor-addon' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'realhomes-elementor-addon' ),
				'label_off'    => esc_html__( 'No', 'realhomes-elementor-addon' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'property_type_bg_color',
			[
				'label'     => esc_html__( 'Property Type Background', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rh_latest-properties .property-types-tax .rh_prop_card__type small' => 'background: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			'property_type_text_color',
			[
				'label'     => esc_html__( 'Property Type Text', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rh_latest-properties .property-types-tax .rh_prop_card__type small' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Price (Current Price)', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .elementor_properties_grid .rh_prop_card__details_elementor .rh_prop_card__priceLabel .rh_prop_card__price .property-current-price' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Price (Old Price)', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .elementor_properties_grid .rh_prop_card__details_elementor .rh_prop_card__priceLabel .rh_prop_card__price .property-old-price' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rh_latest-properties .property-types-tax .rh_prop_card__type small',
			]
		);
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'property_special_label_typography',
				'label'    => esc_html__( 'Property Label', 'realhomes-elementor-addon' ),
				'selector' => '{{WRAPPER}} .rhea_properties_default .rhea-property-label',
			]
		);
...
//			 for date, title, menu_order and rand
		...
		?>
        <section id="rh-<?php echo $this->get_id(); ?>" class="rh_elementor_widget rh_latest-properties rhea_properties_default rhea_ele_property_ajax_target rhea_latest_properties_ajax elementor_properties_grid elementor_property_card_parent rhea_has_tooltip">
			<?php rhea_get_template_part( 'assets/partials/grid-property-loop' ); ?>
        </section>
		<?php
	}
}
