				...
				foreach ( $repeater_city as $city ) {
					...
					if ( $term ) {
                        ...
                        <div class="rhea_property_city">
                            <a class="rhea_property_city_inner" style="flex-direction: <?php echo esc_attr( $settings['rhea_city_position'] ) ?>" href="<?php echo get_term_link( $term_id, 'property-city' ) ?>">

                                <span class="rhea_pc_layer_still" style='background-image: url("<?php echo isset( $image_attributes[0] ) ? esc_url( $image_attributes[0] ) : ''; ?>")'></span>
                                ...
                                <span class="rhea_pc_counter" style="align-self: <?php echo esc_attr( $settings['rhea_counter_align'] ); ?>">
