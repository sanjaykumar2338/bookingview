...
class RHEA_Search_Ultra_Form_Two_WPML_Translate {

	public function __construct() {
		add_filter( 'wpml_elementor_widgets_to_translate', [
			$this,
			'realhomes_ultra_search_form_2_to_translate'
		] );

	}

	public function realhomes_ultra_search_form_2_to_translate( $widgets ) {

		$widgets['rhea-ultra-search-form-2-widget'] = [
			'conditions' => [ 'widgetType' => 'rhea-ultra-search-form-2-widget' ],
			'fields'     => [
				[
					'field'       => 'advance_search_button_label',
					'type'        => esc_html__( 'Advance Search Form: Search Button', 'realhomes-elementor-addon' ),
					'editor_type' => 'LINE'
				],
				[
...
new RHEA_Search_Ultra_Form_Two_WPML_Translate();