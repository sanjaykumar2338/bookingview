...
class RHEA_Testimonial_Widget_Five extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
		...
		wp_register_script(
			'rhea-testimonials-five',
			RHEA_PLUGIN_URL . 'elementor/js/testimonials-five.js',
			[ 'elementor-frontend' ],
			RHEA_VERSION,
			true
		);
	...
	protected function render() {
		...
		if ( $repeater_testimonials ) {
			...
			$animation_type  = $settings['slideAnimation'];
			$animation_speed = $settings['animationSpeed'];
			$autoplay        = 'yes' === $settings['autoplay'];
			$autoplay_speed  = $settings['autoplaySpeed'];
			$animation_loop  = 'yes' === $settings['loop'];
			?>
            <div id="rhea-testimonials-5-widget-<?php echo esc_attr( $widget_id ); ?>" class="rhea-testimonials-5-widget" data-animation-type="<?php echo esc_attr( $animation_type ); ?>" data-animation-speed="<?php echo esc_attr( $animation_speed ); ?>" data-autoplay="<?php echo esc_attr( $autoplay ); ?>" data-autoplay-speed="<?php echo esc_attr( $autoplay_speed ); ?>" data-animation-loop="<?php echo esc_attr( $animation_loop ); ?>">
                <div class="rhea-testimonials-5-widget-bg-placeholder"></div>
                <div class="rhea-testimonials-5-widget-inner-wrapper">
                    <div id="rhea-testimonials-5-widget-carousel-<?php echo esc_attr( $widget_id ); ?>" class="rhea-testimonials-5-widget-carousel owl-carousel owl-theme">
						<?php
                    ...
                    <div id="rhea-testimonials-5-widget-carousel-dots-<?php echo esc_attr( $widget_id ); ?>" class="rhea-testimonials-5-widget-carousel-dots"></div>
