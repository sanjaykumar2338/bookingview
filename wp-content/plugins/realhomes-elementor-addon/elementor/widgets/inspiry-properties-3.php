...
class RHEA_Properties_Widget_three extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label'        => esc_html__( 'Show Agent Verification Badge', 'realhomes-elementor-addon' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'realhomes-elementor-addon' ),
				'label_off'    => esc_html__( 'No', 'realhomes-elementor-addon' ),
				'return_value' => 'yes',
		...
		$this->add_group_control(
			...
			[
				'name'     => 'property_type_top_typography',
				'label'    => esc_html__( 'Type On Thumbnail', 'realhomes-elementor-addon' ),
				'global'   => [
					'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_PRIMARY,
				],
				'selector' => '{{WRAPPER}} .rhea_bottom_tags_box .rhea_property_types small',
			]
		);
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name'     => 'property_status_top_typography',
				'label'    => esc_html__( 'Status On Thumbnail', 'realhomes-elementor-addon' ),
				'global'   => [
					'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_PRIMARY,
				],
				'selector' => '{{WRAPPER}} .rhea_soi_prop_status_sty .rhea_prop_status_sty',
			]
		);
		...
		$this->add_control(
			'type_in_thumbnail_background',
			[
				'label'     => esc_html__( 'Type Background', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rhea_bottom_tags_box .rhea_property_types small' => 'background: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'type_in_thumbnail_text',
			[
				'label'     => esc_html__( 'Type Text', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rhea_bottom_tags_box .rhea_property_types small' => 'color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'status_in_thumbnail_background',
			[
				'label'     => esc_html__( 'Status Background', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rhea_soi_prop_status_sty .rhea_prop_status_sty' => 'background: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'status_in_thumbnail_text',
			[
				'label'     => esc_html__( 'Status Text', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .rhea_soi_prop_status_sty .rhea_prop_status_sty' => 'color: {{VALUE}};',
				],
			]
		);
