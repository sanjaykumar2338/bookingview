...
class RHEA_ultra_Search_Form_2_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'rhea-ultra-search-form-2-widget';
	}

	public function get_title() {
		return esc_html__( 'Ultra Search Form 2', 'realhomes-elementor-addon' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .rhea-ultra-search-form-fields' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);

		$this->add_responsive_control(
			'rhea_search_inner_padding',
			[
				'label'      => esc_html__( 'Search Form Inner Padding', 'realhomes-elementor-addon' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .rhea-search-form-2 .rhea-fields-box' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
...
//					'{{WRAPPER}} .rhea_collapsed_search_fields_inner .rhea_prop_search__option' => 'width: {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Dropdown Background Hover/Active Color', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
...
//		);
		...
		$this->add_responsive_control(
			'search_form_inner_border_radius',
			[
				'label'      => esc_html__( 'Form Inner Border Radius', 'realhomes-elementor-addon' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .rhea-search-form-2 .rhea-fields-box'              => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .rhea-search-form-2 .rhea-ultra-search-form-inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Advance Search Button Border Radius', 'realhomes-elementor-addon' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Search Button Border Radius', 'realhomes-elementor-addon' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
	...
	protected function render() {
		...
		?>
        <div class="rhea_ultra_search_form_wrapper rhea-search-form-2" id="rhea-<?php echo esc_attr( $the_widget_id ); ?>">
