...
class RHEA_How_It_Works_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Divider Width', 'realhomes-elementor-addon' ),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ '%', 'px' ],
				'range'      => [
					'%'  => [
				...
				'devices'    => [ 'widescreen', 'desktop', 'laptop', 'tablet', 'tablet_extra', 'mobile_extra' ],
				'separator'  => 'before',
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__( 'Divider Top Position', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__( 'Divider Top Position Inverted', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 0,
