...
class RHEA_Property_Taxonomy_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'select_layout',
			[
				'label'   => esc_html__( 'Select Style', 'realhomes-elementor-addon' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'default'  => esc_html__( 'Default', 'realhomes-elementor-addon' ),
					'layout-2' => esc_html__( 'Layout 2', 'realhomes-elementor-addon' ),
				),
				'default' => 'default',
		...
		$this->add_control(
			'show_property_count',
			[
				'label'        => esc_html__( 'Show Property Count', 'realhomes-elementor-addon' ),
		...
		$this->add_control(
			'tax_view_all_label',
			[
				'label'     => esc_html__( 'View All', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__( 'View All Typography', 'realhomes-elementor-addon' ),
				'global'   => [
					'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_PRIMARY,
				],
		...
		$this->add_control(
			'view_all_color',
			[
				'label'     => esc_html__( 'View All Color', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
