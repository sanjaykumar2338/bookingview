...
class RHEA_Hero_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Hero Widget', 'realhomes-elementor-addon' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'separator' => 'before',
				'devices'   => [ 'widescreen', 'desktop', 'laptop', 'tablet_extra' ],
				'range'     => [
					'px' => [
						'min' => 0,
						'max' => 1000,
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .rhea-hero-widget-form-field-submit-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'form-submit-button-border-2',
				'selector' => '{{WRAPPER}} .rhea-hero-widget-form .rhea-hero-widget-form-field-submit-button',
			]
		);

		$this->add_control(
			'form-submit-button-border-hover-color',
			[
				'label'     => esc_html__( 'Submit Button Hover Border Color', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .rhea-hero-widget-form-field-submit-button:hover' => 'border-color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .rhea-hero-widget-form-field-submit-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        <div id="<?php echo esc_attr( $widget_id ); ?>" class="rhea-hero-widget-wrapper">
            ...
            <div class="rhea-hero-widget-inner-wrapper">
                <div class="rhea-hero-widget-col-left">
					...
					<?php
					if ( function_exists( 'realhomes_get_dashboard_page_url' ) && rhea_is_rvr_enabled() ) :
						?>
