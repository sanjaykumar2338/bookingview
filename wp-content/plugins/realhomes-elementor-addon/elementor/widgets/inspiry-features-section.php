	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'description' => esc_html__( 'Crop the original image size to any custom size. Set custom width or height to keep the original size ratio.', 'realhomes-elementor-addon' ),
				'default'     => [
					'width'  => '64',
					'height' => '64',
				],
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'selectors'       => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .rhea_modern_features_icon i'   => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} {{CURRENT_ITEM}} .rhea_modern_features_icon svg' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition'       => [
					'rhea_select_icon_type' => 'icon',
				],
