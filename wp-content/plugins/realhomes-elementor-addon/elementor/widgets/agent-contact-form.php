...
class RHEA_Agent_Contact_Form_Widget extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
		...
		wp_register_script(
                'rhea-agent-contact-form',
                RHEA_PLUGIN_URL . 'elementor/js/agent-contact-form-widget.js',
                [ 'elementor-frontend' ],
                RHEA_VERSION,
                true
        );
                        ...
                        <div class="rhea_acf_form">
							...
							if ( 'shortcode' == $settings['rhea_acf_source'] ) {
                                ...
                                <form class="rhea_acf_form_box" id="acf_<?php echo esc_attr( $this->get_id() ); ?>"
                                    ...
                                    <input type="hidden" name="target" value="<?php echo esc_attr( antispambot( $settings['rhea_acf_target_email'] ) ); ?>">

                                    <?php
									if ( ! empty( $settings['rhea_acf_title'] ) ) {
										?>
                                        <input type="hidden" name="agent-name" value="<?php echo esc_attr( $settings['rhea_acf_title'] ); ?>">
										<?php
									}
									?>
                                    ...
                                    <div class="rhea_acf_submit_wrapper">
	                                    <?php
	                                    if( ! empty( $settings['rhea_acf_target_email'] ) && is_email( $settings['rhea_acf_target_email'] ) ) {
                                            ?>
                                            <input id="acf_submit" class="rhea_acf_submit" type="submit" name="submit" value="<?php echo esc_attr( $rhea_acf_button_text ); ?>">
		                                    <?php
	                                    } else {
                                            ?>
                                            <p><?php echo esc_html( 'Target email is not set!', 'realhomes-elementor-addon' ); ?></p>
                                            <?php
	                                    }
	                                    ?>
                                    </div>
