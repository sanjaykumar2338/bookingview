<?php
/**
 * Search button for popup advance fields to display at bottom
 *
 * @since      2.1.2
 */
global $settings, $the_widget_id;
$rhea_search_button_position = isset( $settings['rhea_popup_search_button_position'] ) ? $settings['rhea_popup_search_button_position'] : '';
...
<div class="rhea_search_button_wrapper rhea_button_hide  rhea_buttons_bottom <?php echo esc_attr( $search_button_position_class ); ?>">
	<?php if ( 'yes' == $settings['show_advance_fields'] ) { ?>
        <div class="rhea_advanced_expander rhea_advance_<?php echo esc_attr( $settings['rhea_default_advance_state'] . $rhea_advance_button_animate ) ?>" id="advance_popup_bottom_button_<?php echo esc_attr( $the_widget_id ); ?>">
