...
if ( 'yes' !== $rhea_search_button_position ) {
    ...
    <div class="rhea_search_button_wrapper rhea_buttons_top">
		<?php if ( 'yes' == $settings['show_advance_fields'] ) { ?>
            <div class="rhea_advanced_expander rhea_advance_<?php echo esc_attr( $settings['rhea_default_advance_state'] . $rhea_advance_button_animate ) ?>" id="advance_button_<?php echo esc_attr( $the_widget_id ); ?>">
