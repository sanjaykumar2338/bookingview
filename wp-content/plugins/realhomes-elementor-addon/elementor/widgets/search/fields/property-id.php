...
if ( is_array( $search_fields_to_display ) && in_array( 'property-id', $search_fields_to_display ) ) {
	...
	?>
    <div class="rhea_prop_search__option rhea_mod_text_field rhea_property_id_field <?php echo esc_attr( $separator_class ) ?>" style="order: <?php echo esc_attr( $field_key ); ?>" data-key-position="<?php echo esc_attr( $field_key ); ?>" id="property-id-<?php echo esc_attr( $the_widget_id ); ?>">
		<?php
		...
		?>
        <span class="rhea-text-field-wrapper <?php rhea_add_search_field_icon_class( 'enable_id_icon', $settings ) ?>">
            <?php rhea_generate_search_field_icon( 'id_icon', $settings ); ?>
        <input type="text" name="property-id" autocomplete="off" id="property-id-txt-<?php echo esc_attr( $the_widget_id ); ?>" value="<?php echo isset( $_GET['property-id'] ) ? esc_attr( $_GET['property-id'] ) : ''; ?>" placeholder="<?php echo esc_attr( $settings['property_id_placeholder'] ) ?>"/>
        </span>
    </div>
