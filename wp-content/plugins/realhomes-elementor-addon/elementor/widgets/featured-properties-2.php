...
class RHEA_Featured_Properties_Two_Widget extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
		...
		wp_register_script(
			'rhea-featured-properties-2',
			RHEA_PLUGIN_URL . 'elementor/js/featured-properties-2.js',
			[ 'elementor-frontend' ],
			RHEA_VERSION,
			true
		);
	...
	protected function register_controls() {
		...
		$this->add_control(
			'ere_featured_properties_two_enable_slideshow',
			[
		...
		$this->add_control(
			'ere_featured_properties_two_slideshow_speed',
			[
				'label'     => esc_html__( 'Slideshow Speed (ms)', 'realhomes-elementor-addon' ),
				'condition' => [
					'ere_featured_properties_two_enable_slideshow' => 'yes',
				],
				'type'      => \Elementor\Controls_Manager::NUMBER,
				'min'       => 1000,
				'max'       => 20000,
		...
		$this->add_control(
			'ere_featured_properties_two_animation_speed',
			[
		...
		$this->add_control(
			'ere_featured_properties_two_animation_type',
			[
	...
	protected function render() {
		...
		if ( $featured_properties_query->have_posts() ) {
			 ...
			 */
			$slideshow       = ( 'yes' === $settings['ere_featured_properties_two_enable_slideshow'] ) ? 'true' : 'false';
			$sliding_speed   = ( ! empty( $settings['ere_featured_properties_two_slideshow_speed'] ) ) ? $settings['ere_featured_properties_two_slideshow_speed'] : 3000;
			$animation_speed = ( ! empty( $settings['ere_featured_properties_two_animation_speed'] ) ) ? $settings['ere_featured_properties_two_animation_speed'] : 1000;
			$animation_type  = ( ! empty( $settings['ere_featured_properties_two_animation_type'] ) ) ? $settings['ere_featured_properties_two_animation_type'] : "slide";
			?>
