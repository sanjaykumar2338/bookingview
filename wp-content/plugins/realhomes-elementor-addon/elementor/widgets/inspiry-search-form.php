...
class RHEA_Search_Form_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'dropdown-icon-style',
			[
				'label'   => esc_html__( 'Drop Down Icon Style', 'realhomes-elementor-addon' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'caret',
				'options' => array(
					'caret'   => esc_html__( 'Caret', 'realhomes-elementor-addon' ),
					'chevron' => esc_html__( 'Chevron', 'realhomes-elementor-addon' ),
				),
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__( 'Guests Fields Dropdown Title', 'realhomes-elementor-addon' ),
				'global'   => [
					'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_PRIMARY,
				],
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__( 'Guests Fields Dropdown Age Limit', 'realhomes-elementor-addon' ),
				'global'   => [
					'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_PRIMARY,
				],
...
//					'{{WRAPPER}} .rhea_collapsed_search_fields_inner .rhea_prop_search__option' => 'width: {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Fields Caret Color', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Fields Chevron Color', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .rhea-dropdown-style-chevron .bootstrap-select >.dropdown-toggle .caret' => 'border-right-color: {{VALUE}}; border-bottom-color: {{VALUE}};',
					'{{WRAPPER}} .rhea-dropdown-style-chevron .rhea-guests-field-dropdown-box .caret'     => 'border-right-color: {{VALUE}}; border-bottom-color: {{VALUE}};',
				],
				'condition' => [
		...
		if ( $this->is_rvr_enabled ) {
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Vacation Rental Calender Styles', 'realhomes-elementor-addon' ),
					'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
				]
			);
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Table Cell Hover Background', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'booking_dates_color',
				[
					'label'     => esc_html__( 'Booking Dates Selection Background', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Booking Dates Selection Border', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Booking Dates Range Background', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'table_month_color',
				[
					'label'     => esc_html__( 'Table Month Color', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'table_head_color',
				[
					'label'     => esc_html__( 'Table Head Color', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'table_cell_color',
				[
					'label'     => esc_html__( 'Table Cell Color', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Booking Dates Selection Text Color', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_responsive_control(
				...
				[
					'label'     => esc_html__( 'Date Cell Border Radius', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::SLIDER,
					'range'     => [
						'px' => [
							'min' => 0,
			...
			$this->add_group_control(
				...
				[
					...
					'label'    => esc_html__( 'Table Month', 'realhomes-elementor-addon' ),
			...
			$this->add_group_control(
				...
				[
					...
					'label'    => esc_html__( 'Table Head', 'realhomes-elementor-addon' ),
			...
			$this->add_group_control(
				...
				[
					...
					'label'    => esc_html__( 'Table Cell', 'realhomes-elementor-addon' ),
		...
		if ( $this->is_rvr_enabled ) {
			...
			$this->add_control(
				'guests_field_type',
				[
					'label'       => esc_html__( 'Type Of Guests Fields', 'realhomes-elementor-addon' ),
					'type'        => \Elementor\Controls_Manager::SELECT2,
					'default'     => 'default',
					'label_block' => true,
					'options'     => array(
						'default'     => esc_html__( 'Default', 'realhomes-elementor-addon' ),
						'guest-types' => esc_html__( 'Guests Categories', 'realhomes-elementor-addon' ),
					),
				]
			);
			...
			$this->add_control(
				'adults_label',
				[
					'label'     => esc_html__( 'Adults Label', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::TEXT,
			...
			$this->add_control(
				'adults_age_limit',
				[
					'label'     => esc_html__( 'Adults Age Limit', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::TEXT,
					'default'   => esc_html__( '(12+ yrs)', 'realhomes-elementor-addon' ),
					'condition' => [
						'guests_field_type' => 'guest-types',
					],
				]
			...
			$this->add_control(
				'children_label',
				[
					'label'     => esc_html__( 'Children Label', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::TEXT,
			...
			$this->add_control(
				'children_age_limit',
				[
					'label'     => esc_html__( 'Children Age Limit', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::TEXT,
					'default'   => esc_html__( '( 2-12 yrs)', 'realhomes-elementor-addon' ),
					'condition' => [
						'guests_field_type' => 'guest-types',
					],
				]
			...
			$this->add_control(
				'infants_label',
				[
					'label'     => esc_html__( 'Infants Label', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::TEXT,
			...
			$this->add_control(
				'infants_age_limit',
				[
					'label'     => esc_html__( 'Infants Age Limit', 'realhomes-elementor-addon' ),
					'type'      => \Elementor\Controls_Manager::TEXT,
					'default'   => esc_html__( '( < 2 yrs)', 'realhomes-elementor-addon' ),
					'condition' => [
						'guests_field_type' => 'guest-types',
					],
				]
		...
		$this->add_control(
			...
			[
				'label'        => esc_html__( 'Show Features In Drop Down ?', 'realhomes-elementor-addon' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'realhomes-elementor-addon' ),
				'label_off'    => esc_html__( 'No', 'realhomes-elementor-addon' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Dropdown Fields Options', 'realhomes-elementor-addon' ),
				'type'      => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Placeholder', 'realhomes-elementor-addon' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'All features', 'realhomes-elementor-addon' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_html__( 'Placeholder text when more than 2 values are being selected', 'realhomes-elementor-addon' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => esc_html__( 'Features Selected', 'realhomes-elementor-addon' ),
			]
		);
	...
	protected function render() {
		...
		?>
        <div class="rhea_search_form_wrapper rhea-dropdown-style-<?php echo esc_attr( $settings['dropdown-icon-style'] ) . ' rhea-radius-position-' . ( isset( $settings['radius-slider-position'] ) ? esc_attr( $settings['radius-slider-position'] ) : '' ) ?>" id="rhea-<?php echo esc_attr( $the_widget_id ); ?>">
