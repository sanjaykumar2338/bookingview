/**
 * ES6 Class for Elementor Ultra Single Property Fullwidth Slider
 *
 * @since 2.1.0
 * */

class RHEAUltraSinglePropertyFullWidthSlider extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {

        return {
            selectors : {
                propertySlider   : '.rhea-ultra-property-slider',
                propertyCarousel : '.rhea-ultra-vertical-carousel-trigger'
            }
        };
    }
...
jQuery( window ).on( 'elementor/frontend/init', () => {
    const singlePropertyFullwidthWidgetHandler = ( $element ) => {
        elementorFrontend.elementsHandler.addHandler( RHEAUltraSinglePropertyFullWidthSlider, {
            $element
        } );
    };

    elementorFrontend.hooks.addAction( 'frontend/element_ready/rhea-ultra-single-property-slider-fullwidth.default', singlePropertyFullwidthWidgetHandler );
} );