...
<article class="rhea_agent_two">
    ...
    <div class="rhea_agent_two_wrap">
		<?php
		if ( $agent['rhea_agent_image'] ) {
			?>
            <div class="rhea_agent_two_thumbnail">
				<?php
				if (
					$agent['rhea_agent_url']['url'] &&
					! empty( $agent['rhea_agent_url']['url'] )
				) {
					...
					?>
                    <a
                        class="rhea_agent_two_thumb"
                        href="<?php echo esc_url( $agent['rhea_agent_url']['url'] ) ?>"
        ...
        <div class="rhea_agent_two_details">
			...
			if ( $agent['rhea_agent_facebook']['url'] ||
                ...
                <ul class="rhea_agent_two_socials">
					...
					if ( $agent['rhea_agent_facebook']['url'] ) {
                        ...
                        <li class="rhea_item_facebook">
                            <a
                                href="<?php echo esc_url( $agent['rhea_agent_facebook']['url'] ); ?>"
								<?php echo esc_attr( $agent_fb_target ); ?>
								<?php echo esc_attr( $agent_fb_nofollow );  ?>
                                <?php echo esc_attr( $agent_fb_custom_attributes ); ?>
                            >
					...
					if ( $agent['rhea_agent_twitter']['url'] ) {
                        ...
                        <li class="rhea_item_twitter">
                            <a
                                href="<?php echo esc_url( $agent['rhea_agent_twitter']['url'] ); ?>"
								<?php echo esc_attr( $agent_twitter_target ); ?>
                                <?php echo esc_attr( $agent_twitter_nofollow ); ?>
                                <?php echo esc_attr( $agent_twitter_custom_attributes ); ?>
                            >
					...
					if ( $agent['rhea_agent_linkedin']['url'] ) {
                        ...
                        <li class="rhea_item_linkedin">
                            <a
                                href="<?php echo esc_url( $agent['rhea_agent_linkedin']['url'] ); ?>"
								<?php echo esc_attr( $agent_in_target ); ?>
                                <?php echo esc_attr( $agent_in_nofollow ); ?>
                                <?php echo esc_attr( $agent_in_custom_attributes ); ?>
                            >
					...
					if ( $agent['rhea_agent_instagram']['url'] ) {
                        ...
                        <li class="rhea_item_instagram">
                            <a
                                href="<?php echo esc_url( $agent['rhea_agent_instagram']['url'] ); ?>"
								<?php echo esc_attr( $agent_insta_target ); ?>
                                <?php echo esc_attr( $agent_insta_nofollow ); ?>
                                <?php echo esc_attr( $agent_insta_custom_attributes ); ?>
                            >
					...
					if ( $agent['rhea_agent_pinterest']['url'] ) {
                        ...
                        <li class="rhea_item_pinterest">
                            <a
                                href="<?php echo esc_url( $agent['rhea_agent_pinterest']['url'] ); ?>"
								<?php echo esc_attr( $agent_pi_target ); ?>
                                <?php echo esc_attr( $agent_pi_nofollow ); ?>
                                <?php echo esc_attr( $agent_pi_custom_attributes ); ?>
                            >
					...
					if ( $agent['rhea_agent_youtube']['url'] ) {
                        ...
                        <li class="rhea_item_youtube">
                            <a
                                href="<?php echo esc_url( $agent['rhea_agent_youtube']['url'] ); ?>"
								<?php echo esc_attr( $agent_yt_target ); ?>
                                <?php echo esc_attr( $agent_yt_nofollow ); ?>
                                <?php echo esc_attr( $agent_yt_custom_attributes ); ?>
                            >
                ...
                <!-- ending .rhea_agent_two_socials ul -->
				<?php
			}
			...
			if ( $agent['rhea_agent_phone'] && ! empty( $agent['rhea_agent_phone'] ) ) {
				?>
                <div class="rhea_agent_two_meta number">
			...
			if ( $agent['rhea_agent_whatsapp'] && ! empty( $agent['rhea_agent_whatsapp'] ) ) {
				$agent_whatsapp_link = 'https://wa.me/' . str_replace( '-', '', $agent['rhea_agent_whatsapp'] );
				?>
                <div class="rhea_agent_two_meta number">
                    <i class="fab fa-whatsapp"></i>
                    <a href="<?php echo esc_url( $agent_whatsapp_link ); ?>">
						<?php echo esc_html( $agent['rhea_agent_whatsapp'] ); ?>
                    </a>
                </div>
				<?php
			}

			if ( $agent['rhea_agent_website'] && ! empty( $agent['rhea_agent_website'] ) ) {
				?>
                <div class="rhea_agent_two_meta website">
                    <i class="fas fa-link"></i>
                    <a href="<?php echo esc_url( $agent['rhea_agent_website'] ); ?>">
						<?php echo esc_url( $agent['rhea_agent_website'] ); ?>
                    </a>
                </div>
				<?php
			}
			...
			if ( $agent['rhea_agent_email'] && ! empty( $agent['rhea_agent_email'] ) ) {
                ...
                <div class="rhea_agent_two_meta email">
                    ...
                    <a href="mailto:<?php echo esc_attr( antispambot( $agent['rhea_agent_email'] ) ); ?>">
