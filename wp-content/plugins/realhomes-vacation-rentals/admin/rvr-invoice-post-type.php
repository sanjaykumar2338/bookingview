...
if ( ! class_exists( 'RVR_Invoice' ) ) {
	...
	class RVR_Invoice {
		...
		public function add_invoice_payment_metabox() {
			add_meta_box( 'invoice-payment-metabox', esc_html__( 'Invoice Information', 'realhomes-vacation-rentals' ), array(
				$this,
