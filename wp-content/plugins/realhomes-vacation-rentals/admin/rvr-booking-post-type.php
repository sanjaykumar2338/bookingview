...
if ( ! class_exists( 'RVR_Booking' ) ) {
	...
	class RVR_Booking {
		...
		public function rvr_booking_meta_boxes( $meta_boxes ) {
			...
			$additional_amenities_info = esc_html__( 'No additional amenities are added to this booking.', 'realhomes-vacation-rentals' );

			if ( ! empty( $additional_amenities ) && is_array( $additional_amenities ) ) {
				$additional_amenities_info = '<div class="rvr-additional-fees-info"><h3>' . esc_html__( 'Additional Amenities Details', 'realhomes-vacation-rentals' ) . '</h3><table>';
			...
			if ( ! empty( $additional_fees ) && is_array( $additional_fees ) ) {
				$additional_fees_info = '<div class="rvr-additional-fees-info"><h3>' . esc_html__( 'Additional Fees Details', 'realhomes-vacation-rentals' ) . '</h3><table>';
			...
			$meta_boxes[] = array(
				...
				'fields' => array(
					...
					array(
						'type' => 'heading',
						'desc' => esc_html__( 'Renter Info', 'realhomes-vacation-rentals' ),
					),
					array(
		...
		public function booking_edit_columns( $columns ) {
			...
			$columns = array(
				...
				'property_title' => esc_html__( 'Booked Property', 'realhomes-vacation-rentals' ),
