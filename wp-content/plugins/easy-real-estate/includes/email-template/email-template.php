...
// Getting Styles based on design and Customizer selection
$email_styles = ere_email_template_styles();

// Generating style variables
$header_content     = $email_styles['header_content'];
$header_title_color = $email_styles['header_title_color'];
$background_color   = $email_styles['background_color'];
$body_link_color    = $email_styles['body_link_color'];
$footer_text        = $email_styles['footer_text'];
$footer_text_color  = $email_styles['footer_text_color'];
$footer_link_color  = $email_styles['footer_link_color'];
