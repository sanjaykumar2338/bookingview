...
$unit                             = esc_html__( 'sq ft', 'easy-real-estate' );
...
<div class="inspiry-ere-page-content">
    <form method="post" action="" novalidate="novalidate">
        ...
        <table class="form-table">
            ...
            <tr>
                <th scope="row">
                    <label for="ere_area_unit"><?php esc_html_e( 'Area Size Unit', 'easy-real-estate' ) ?></label>
                </th>
                <td>
                    <input name="ere_area_unit" type="text" id="ere_area_unit" value="<?php echo esc_attr( $ere_area_unit ); ?>" class="regular-text code">
                    <p class="description">
						<?php esc_html_e( 'Default: sq ft', 'easy-real-estate' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label for="ere_lot_unit"><?php esc_html_e( 'Lot Size Unit', 'easy-real-estate' ) ?></label>
                </th>
                <td>
