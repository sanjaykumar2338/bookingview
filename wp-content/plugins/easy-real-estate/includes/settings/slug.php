...
$ere_agent_location_slug       = $this->get_option( 'ere_agent_location_slug', esc_html__( 'agent-location', 'easy-real-estate' ) );
$inspiry_agency_slug           = $this->get_option( 'inspiry_agency_slug', esc_html__( 'agency', 'easy-real-estate' ) );
$ere_agency_location_slug      = $this->get_option( 'ere_agency_location_slug', esc_html__( 'agency-location', 'easy-real-estate' ) );
...
<div class="inspiry-ere-page-content">
    ...
    <form method="post" action="" novalidate="novalidate">
        <table class="form-table">
            ...
            <tr>
                <th scope="row"><label for="ere_agent_location_slug"><?php esc_html_e( 'Agent Location Slug', 'easy-real-estate' ); ?></label></th>
                <td><input name="ere_agent_location_slug" type="text" id="ere_agent_location_slug" value="<?php echo esc_attr( $ere_agent_location_slug ); ?>" class="regular-text code"></td>
            </tr>
            <tr>
            ...
            <tr>
                <th scope="row"><label for="ere_agency_location_slug"><?php esc_html_e( 'Agency Location Slug', 'easy-real-estate' ); ?></label></th>
                <td><input name="ere_agency_location_slug" type="text" id="ere_agency_location_slug" value="<?php echo esc_attr( $ere_agency_location_slug ); ?>" class="regular-text code"></td>
            </tr>
            <tr>
