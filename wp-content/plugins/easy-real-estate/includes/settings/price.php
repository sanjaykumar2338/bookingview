...
<div class="inspiry-ere-page-content">
    ...
    <form method="post" action="" novalidate="novalidate">
        <table class="form-table">
            <tbody>
            <tr>
                <th scope="row"><label for="theme_currency_sign"><?php esc_html_e( 'Currency Sign', 'easy-real-estate' ); ?></label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row"><label for="theme_decimals"><?php esc_html_e( 'Number of Decimals Points', 'easy-real-estate' ); ?></label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row"><label for="theme_dec_point"><?php esc_html_e( 'Decimal Point Separator', 'easy-real-estate' ); ?></label>
                </th>
            ...
            <tr>
                <th scope="row"><label for="theme_thousands_sep"><?php esc_html_e( 'Thousands Separator', 'easy-real-estate' ); ?></label>
                </th>
            ...
            <tr>
                <th scope="row">
                    <label for="ere_price_prefix"><?php esc_html_e( 'Price Prefix', 'easy-real-estate' ) ?></label>
                </th>
                <td>
                    ...
                    <p class="description">
			            <?php esc_html_e( 'Example: From', 'easy-real-estate' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label for="ere_price_postfix"><?php esc_html_e( 'Price Postfix', 'easy-real-estate' ) ?></label>
                </th>
                <td>
                    ...
                    <p class="description">
						<?php esc_html_e( 'Example: Monthly or Per Night', 'easy-real-estate' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
                <th scope="row"><label for="theme_no_price_text"><?php esc_html_e( 'Empty Price Text', 'easy-real-estate' ); ?></label>
                </th>
                <td>
