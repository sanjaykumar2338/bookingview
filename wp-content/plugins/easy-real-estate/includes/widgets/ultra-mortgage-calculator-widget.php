                    ...
                    <div class="rh_property__mc clearfix">
                        ...
                        <div class="mc_right_side <?php echo 'graph_' . esc_attr( $graph_type ); ?>">
							...
							if ( 'true' !== $hoa_field_display ) {
								...
								$hoa_field_label = get_option( 'inspiry_mc_second_field_title', esc_html__( 'Other Dues', 'easy-real-estate' ) );
							}
							...
							<?php esc_html_e( 'Years Fixed', 'easy-real-estate' ); ?>
                            </span>
                                    </div>
                                    <div class="rh-mc-label-box">
                                        <span class="mc_interest_value rh-mc-value"><?php echo esc_attr( $mc_default['interest'] ); ?></span><span class="rh-mc-percent">%</span>
                                        <span class="rh-mc-label">
							<?php echo esc_html( $interest_label ); ?>
                                ...
                                <div class="mc_term_interest">
                                    <span class="mc_term_value"><?php echo esc_html( $mc_default['term'] ); ?></span> <?php esc_html_e( 'Years Fixed', 'easy-real-estate' ); ?>
                                    ,
                                    <span class="mc_interest_value"><?php echo esc_attr( $mc_default['interest'] ); ?></span><span>%</span> <?php echo esc_html( $interest_label ); ?>
                                </div>
                            ...
                            <div class="mc_cost">
                                <ul>
                                    <li class="mc_cost_interest"><?php echo esc_html( $principle_label ); ?>
                                        <span></span></li>
									<?php
                        ...
                        <div class="mc_left_side">
                            ...
                            <div class="rh_mc_field">
                                ...
                                <div class="rh_form__item">
									...
									if ( 'ultra' === INSPIRY_DESIGN_VARIATION ) {
										ere_safe_include_svg( '/images/icons/ultra/calendar.svg' );
									}
									?>
                                    <select name="mc_term" class="rh-ultra-select-dropdown mc_term inspiry_select_picker_trigger show-tick">
										<?php
                            ...
                            <div class="rh_mc_field">
                                ...
                                <div class="rh_form__item rh-mc-slider-fields">
									<?php
									if ( 'ultra' === INSPIRY_DESIGN_VARIATION ) {
										ere_safe_include_svg( '/images/icons/ultra/calculator.svg' );
									}
									?>
                            ...
                            <div class="rh_mc_field">
                                ...
                                <div class="rh_form__item rh-mc-slider-fields">
									<?php
									if ( 'ultra' === INSPIRY_DESIGN_VARIATION ) {
										ere_safe_include_svg( '/images/icons/ultra/money.svg' );
									}
									?>
