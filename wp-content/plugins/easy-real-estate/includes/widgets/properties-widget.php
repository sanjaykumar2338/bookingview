	...
	class Inspiry_Properties_Widget extends WP_Widget {
		...
		function form( $instance ) {
			...
			if ( 'ultra' !== INSPIRY_DESIGN_VARIATION ) {
				?>
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'card_design' ) ); ?>"><?php esc_html_e( 'Property Card Design', 'easy-real-estate' ); ?></label>
                    <select name="<?php echo esc_attr( $this->get_field_name( 'card_design' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'card_design' ) ); ?>" class="widefat">
                        <option value="default"<?php selected( $card_design, 'default' ); ?>><?php esc_html_e( 'Default', 'easy-real-estate' ); ?></option>
                        <option value="1"<?php selected( $card_design, '1' ); ?>><?php esc_html_e( 'One', 'easy-real-estate' ); ?></option>
                        <option value="2"<?php selected( $card_design, '2' ); ?>><?php esc_html_e( 'Two', 'easy-real-estate' ); ?></option>
                        <option value="3"<?php selected( $card_design, '3' ); ?>><?php esc_html_e( 'Three', 'easy-real-estate' ); ?></option>
                        <option value="4"<?php selected( $card_design, '4' ); ?>><?php esc_html_e( 'Four', 'easy-real-estate' ); ?></option>
                        <option value="5"<?php selected( $card_design, '5' ); ?>><?php esc_html_e( 'Five', 'easy-real-estate' ); ?></option>
                    </select>
                </p>
				<?php
			}
			...
			if ( 'ultra' !== INSPIRY_DESIGN_VARIATION ) {
                ...
                <p><?php
					if ( 'modern' === INSPIRY_DESIGN_VARIATION ) {
						?>
                        <label for="<?php echo esc_attr( $this->get_field_id( 'view_property' ) ); ?>"><?php esc_html_e( 'View Property', 'easy-real-estate' ); ?></label><?php
					} else if ( 'classic' === INSPIRY_DESIGN_VARIATION ) {
						?>
                        <label for="<?php echo esc_attr( $this->get_field_id( 'view_property' ) ); ?>"><?php esc_html_e( 'Read More', 'easy-real-estate' ); ?></label><?php
					}
					?>
			...
			if ( ! empty( $all_locations ) ) {
                ...
                <p class="tax-option">
					...
					foreach ( $all_locations as $location_slug => $location_name ) {
						...
						?>
                        <label><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'property_location' ) ); ?>[]" value="<?Php echo esc_attr( $location_slug ); ?>" <?php echo $checked; ?>> <?php echo esc_html( $location_name ); ?>
                        </label>
						<?php
					}
					?>
			...
			if ( ! empty( $all_statuses ) ) {
                ...
                <p class="tax-option">
					...
					foreach ( $all_statuses as $status_slug => $status_name ) {
						...
						?>
                        <label><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'property_status' ) ); ?>[]" value="<?Php echo esc_attr( $status_slug ); ?>" <?php echo $checked; ?>> <?php echo esc_html( $status_name ); ?>
                        </label>
						<?php
					}
					?>
			...
			if ( ! empty( $all_types ) ) {
                ...
                <p class="tax-option">
					...
					foreach ( $all_types as $type_slug => $type_name ) {
						...
						?>
                        <label><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'property_type' ) ); ?>[]" value="<?php echo esc_attr( $type_slug ); ?>" <?php echo $checked; ?>> <?php echo esc_html( $type_name ); ?>
                        </label>
						<?php
					}
					?>
			...
			if ( ! empty( $all_features ) ) {
                ...
                <p class="tax-option">
					...
					foreach ( $all_features as $term_slug => $term_name ) {
						...
						?>
                        <label><input type="checkbox" name="<?php echo esc_attr( $this->get_field_name( 'property_feature' ) ); ?>[]" value="<?Php echo $term_slug; ?>" <?php echo $checked; ?>> <?php echo $term_name; ?>
                        </label>
						<?php
					}
					?>
