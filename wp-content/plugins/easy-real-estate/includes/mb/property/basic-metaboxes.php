...
function ere_basic_metabox_fields( $property_metabox_fields ) {
	...
	if ( function_exists( 'inspiry_is_rvr_enabled' ) && ! inspiry_is_rvr_enabled() ) {
		$price_fields = array(
			...
			array(
				...
				'desc'    => esc_html__( 'Example: From. Provide a value to override the global prefix value, or use \'None\' to disable it in case you do not want a prefix at all.', 'easy-real-estate' ),
				'type'    => 'text',
				'std'     => '',
				'columns' => 6,
				'tab'     => 'details',
			...
			array(
				...
				'desc'    => esc_html__( 'Example: Monthly or Per Night. Provide a value to override the global postfix value, or use \'None\' to disable it in case you do not want a postfix at all.', 'easy-real-estate' ),
				'type'    => 'text',
				'std'     => '',
				'columns' => 6,
				'tab'     => 'details',
	...
	$ere_basic_fields = array(
		...
		array(
			...
			'desc'    => esc_html__( 'Example: sq ft. Provide a value to override the global postfix value, or use \'None\' to disable it in case you do not want a postfix at all.', 'easy-real-estate' ),
		...
		array(
			...
			'clone'      => true,
			'sort_clone' => true,
			'add_button' => esc_html__( '+ Add More', 'easy-real-estate' ),
			'options'    => array(
