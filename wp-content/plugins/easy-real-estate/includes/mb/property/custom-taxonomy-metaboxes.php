...
if ( ! function_exists( 'ere_property_taxonomy_term_color_meta_boxes' ) ) {
	...
	function ere_property_taxonomy_term_color_meta_boxes( $meta_boxes ) {
		...
		$meta_boxes[] = array(
			'title'      => esc_html__( 'Term Color', 'easy-real-estate' ),
			'taxonomies' => array(
				'property-status',
				'property-city',
				'property-type'
			...
			'fields'     => array(
				array(
					'name'          => esc_html__( '&nbsp;', 'easy-real-estate' ),
					'desc'          => esc_html__( 'This color will be applied to charts depicting property statistics categorized by taxonomy terms on the Agents and Agencies detail page.', 'easy-real-estate' ),
