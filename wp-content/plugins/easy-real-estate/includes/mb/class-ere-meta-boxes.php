		...
		if ( is_plugin_active( 'meta-box/meta-box.php' ) ) {
			...
			add_action( 'admin_notices', function () {
                ...
                <div class="update-nag notice is-dismissible">
                    <p>
                        <strong><?php esc_html_e( 'Meta Box plugin has been deactivated!', 'easy-real-estate' ); ?></strong>
                    </p>
                    <p><?php esc_html_e( 'As similar functionality is already embedded with in Easy Real Estate plugin.', 'easy-real-estate' ); ?></p>
                    <p>
                        <em><?php esc_html_e( 'So, You should completely remove it from your plugins.', 'easy-real-estate' ); ?></em>
                    </p>
                </div>
				<?php
			} );
