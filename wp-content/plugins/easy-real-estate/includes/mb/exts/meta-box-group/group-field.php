...
class RWMB_Group_Field extends RWMB_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		wp_localize_script(
			...
			'RWMB_Group',
			array(
				'confirmRemove' => esc_html__( 'Are you sure you want to remove this group?', 'meta-box-group' ),
			)
		);
	}
	...
	public static function normalize( $field ) {
		...
		$field = wp_parse_args( $field, [
			'collapsible'   => false,
			'save_state'    => false,
			'group_title'   => $field['clone'] ? esc_html__( 'Entry {#}', 'meta-box-group' ) : esc_html__( 'Entry', 'meta-box-group' ),
