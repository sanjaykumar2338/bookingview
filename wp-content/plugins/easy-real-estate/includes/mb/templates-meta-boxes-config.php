			...
			'fields'     => array(
				...
				array(
					...
					'options'  => array(
						...
						'title-asc'  => esc_html__( 'Property Title - A to Z', 'easy-real-estate' ),
						'title-desc' => esc_html__( 'Property Title - Z to A', 'easy-real-estate' ),
				...
				array(
					...
					'name'      => esc_html__( 'Disable AJAX Pagination', 'easy-real-estate' ),
					'type'      => 'switch',
					'style'     => 'square',
...
if ( ! function_exists( 'ere_gallery_properties_filter_meta_boxes' ) ) :
	...
	function ere_gallery_properties_filter_meta_boxes( $meta_boxes ) {
		...
		$meta_boxes[] = array(
			...
			'fields'     => array(
				 array(
					'name'    => esc_html__( 'Number of Columns', 'easy-real-estate' ),
					'id'      => 'realhomes_properties_gallery_column',
					'type'    => 'select',
					'std'     => '3',
					'options' => array(
						'2'       => esc_html__( '2', 'easy-real-estate' ),
						'3'       => esc_html__( '3', 'easy-real-estate' ),
						'4'       => esc_html__( '4', 'easy-real-estate' ),
					),
				...
				array(
					...
					'name' => esc_html__( 'Number of Properties Per Page', 'easy-real-estate' ),
					'desc' => esc_html__( 'Use any integer value. To show all properties use -1 instead.', 'easy-real-estate' ),
					'type' => 'text',
					'std'  => 6,
					'columns' => 6,
				),
