...
if ( ! function_exists( 'inspiry_make_properties_stick_at_top' ) ) {
	...
	function inspiry_make_properties_stick_at_top( $posts, $query ) {
		...
		if ( is_main_query() && ( is_page_template( array( 'templates/properties.php', 'templates/home.php' ) ) ) ) {
			...
			if ( isset( $_GET['sortby'] ) && ( 'default' !== $_GET['sortby'] ) && ( is_page_template( 'templates/properties.php' ) ) ) {
				return $posts;
			}
