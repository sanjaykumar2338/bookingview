<div class="dashboard-posts-list-head">
    <div class="large-column-wrap">
        ...
        <div class="column column-info"><span><?php esc_html_e( 'Agency Info', 'framework' ); ?></span></div>
    </div>
    <div class="small-column-wrap">
        <div class="column column-agency-agents"><span><?php esc_html_e( 'Agents Count', 'framework' ); ?></span></div>
