...
<form id="submit-property-form" class="submit-property-form <?php echo esc_attr( $form_class ); ?>" enctype="multipart/form-data" method="post">
    <div id="dashboard-tabs" class="dashboard-tabs">
        ...
        <div id="dashboard-tabs-contents" class="dashboard-tabs-contents">
            ...
            <div class="dashboard-tab-content form-fields current-tab-content" data-content-title="<?php esc_html_e( 'Basic', 'framework' ); ?>">
                <div class="row">
					<?php
					// Property Title
					...
					// Property Old Price
					if ( in_array( 'old-price', $inspiry_submit_fields, true ) ) { ?>
                        <div class="col-md-6 col-lg-4">
			...
			if ( in_array( 'images', $inspiry_submit_fields, true ) ||
				...
				?>
                <div class="dashboard-tab-content form-fields" data-content-title="<?php esc_html_e( 'Gallery', 'framework' ); ?>">
                    <div class="row">
						<?php
						// Gallery Images
						if ( in_array( 'images', $inspiry_submit_fields, true ) ) { ?>
			...
			if ( in_array( 'features', $inspiry_submit_fields, true ) ||
				...
				?>
                <div class="dashboard-tab-content form-fields" data-content-title="<?php esc_html_e( 'Features', 'framework' ); ?>">
                    <div class="row">
						<?php
						// Additional Details
