...
} elseif ( 'ultra' === INSPIRY_DESIGN_VARIATION ) {
	$form_design = 'rh_login_modal_ultra';
}
                ...
                <div class="rh_wapper_quote_contents">
					...
					if ( 'true' == $inspiry_login_date_day_display ) {
                        ...
                        <div class="rh_login_date_box">
                            <span class="rh_login_date"><?php echo wp_date( get_option( 'date_format' ) ); ?></span>
							...
							foreach ( $user_fields as $field ) {
								...
								if ( ! empty( $field['id'] ) && ! empty( $field['name'] ) ) {
									...
									if ( ! empty( $field['type'] ) && $field['type'] == 'select' && ! empty( $field['options'] ) && is_array( $field['options'] ) ) {
										...
										?>
                                        <input class="rh_modal_input_cb" type="checkbox" id="<?php echo esc_attr( $field['id'] ); ?>" name="<?php echo esc_attr( $field['id'] ); ?>" value="<?php echo esc_attr( $field['std'] ); ?>">
                                        <label class="rh_modal_label_cb" for="<?php echo esc_attr( $field['id'] ); ?>"><span><?php echo esc_attr( $field['title'] ); ?></span></label>
										<?php
									} else {
										?>
                                        <label class="rh_modal_labels"
