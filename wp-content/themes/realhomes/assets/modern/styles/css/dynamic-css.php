...
if ( ! function_exists( 'inspiry_generate_dynamic_css' ) ) {
	...
	function inspiry_generate_dynamic_css( $realhomes_modern_custom_css ) {
		...
		if ( 'fixed' === get_option( 'inspiry_banner_image_attachment', 'parallax' ) ) {
			$banner_ind_styles[] = array(
		...
		$banner_image_position = get_option( 'inspiry_banner_image_position', 'default' );
		...
		$banner_image_size = get_option( 'inspiry_banner_image_size', 'default' );
		...
		$inspiry_property_favorite_icon_color           = get_option( 'inspiry_property_favorite_icon_color', '#ffffff' );
		$inspiry_property_favorite_icon_hover_color     = get_option( 'inspiry_property_favorite_icon_hover_color', '#ea3d3d' );
		$realhomes_favorite_icon_placeholder_color      = get_option( 'realhomes_favorite_icon_placeholder_color', '#ea3d3d' );
		$inspiry_property_compare_icon_color            = get_option( 'inspiry_property_compare_icon_color', '#ffffff' );
		$inspiry_property_compare_icon_hover_color      = get_option( 'inspiry_property_compare_icon_hover_color', '#ea723d' );
		$realhomes_compare_icon_placeholder_color       = get_option( 'realhomes_compare_icon_placeholder_color', '#ea723d' );
		$inspiry_property_tooltip_bgcolor               = get_option( 'inspiry_property_tooltip_bgcolor', '#ea723d' );
		$inspiry_property_tooltip_color                 = get_option( 'inspiry_property_tooltip_color', '#ffffff' );
		$inspiry_property_grid_card_address_color       = get_option( 'inspiry_property_grid_card_address_color', '#1f79b8' );
		$inspiry_property_grid_card_address_hover_color = get_option( 'inspiry_property_grid_card_address_hover_color', '#ea723d' );
		...
		$dynamic_css = array(
			...
			array(
				'elements' => '.rh_agent_card__wrap .rh_agent_card__head .rh_agent_card__name .name .rh_agent_verification__icon,
				               .rh_view_type a svg path',
				'property' => 'background',
				'value'    => $core_green_color,
			),
			...
			array(
				'elements' => '.rh_prop_card .rh_prop_card__details,
			...
			array(
				'elements' => '.rh_prop_card .rh_prop_card__details h3 a, 
			...
			array(
				'elements' => '.rh_prop_card .rh_prop_card__details h3 a:hover, 
				.rh_list_card__wrap .rh_list_card__map_wrap h3 a:hover, 
				.rh_list_card__wrap .rh_list_card__details_wrap h3 a:hover,
				h3.rh_heading_stylish a:hover',
				'property' => 'color',
			...
			array(
				'elements' => '.rh_prop_card .rh_prop_card__details .rh_prop_card__priceLabel .rh_prop_card__price,
				 .rh_list_card__wrap .rh_list_card__map_details .rh_list_card__priceLabel .rh_list_card__price .price, 
				 .rh_list_card__wrap .rh_list_card__priceLabel .rh_list_card__price .price,
				 .rh_theme_card__priceLabel_sty .rh_theme_card__price_sty
				 ',
			...
			array(
				'elements' => '.rh_prop_card .rh_prop_card__details .rh_prop_card__meta .figure, .rh_list_card__meta div .label, .rh_list_card__meta div .figure,
			...
			array(
				'elements' => '.rh_list_card__wrap .rh_list_card__thumbnail .rh_list_card__btns a svg path, 
			...
			array(
				'elements' => '.rh_list_card__wrap .rh_list_card__thumbnail .rh_list_card__btns .favorite:hover svg path, 
			...
			array(
				'elements' => '.rh_list_card__wrap .rh_list_card__thumbnail .rh_list_card__btns .favorite-placeholder svg path,
			...
			array(
				'elements' => '.rh_list_card__wrap .rh_list_card__thumbnail .rh_list_card__btns .rh_trigger_compare svg path,
			...
			array(
				'elements' => '.rh_list_card__wrap .rh_list_card__thumbnail .rh_list_card__btns .rh_trigger_compare:hover svg path,
			...
			array(
				'elements' => '.rh_list_card__wrap .rh_list_card__thumbnail .rh_list_card__btns .compare-placeholder svg path,
			...
			array(
				'elements' => '.rh_latest_properties_2 .rh_tags_wrapper .rh_featured:before',
				'property' => 'border-color',
				'value'    => get_option( 'inspiry_grid_card_featured_tag_bg_color', '#1ea69a' ),
			),
			array(
				'elements' => '.rh_latest_properties_2 .rh_tags_wrapper .rh_featured:before',
				'property' => 'border-bottom-color',
			...
			array(
				...
				'property' => 'fill',
				'value'    => get_option( 'inspiry_grid_card_featured_tag_color', '#fff' ),
			),
			array(
				'elements' => '.rh_latest_properties_2 .rh_tags_wrapper .rh_hot:before',
				'property' => 'border-color',
				'value'    => get_option( 'inspiry_grid_card_trend_tag_bg_color', '#d22d3e' ),
			),
			array(
				'elements' => '.rh_latest_properties_2 .rh_tags_wrapper .rh_hot:before',
				'property' => 'border-bottom-color',
			...
			array(
				...
				'property' => 'fill',
				'value'    => get_option( 'inspiry_grid_card_trend_tag_color', '#fff' ),
			),
			array(
				'elements' => '.rh_prop_status_sty',
				'property' => 'background-color',
				'value'    => get_option( 'inspiry_grid_card_status_tag_bg_color', '#000' ),
			),
			array(
				'elements' => '.rh_prop_status_sty',
				'property' => 'color',
				'value'    => get_option( 'inspiry_grid_card_status_tag_color', '#fff' ),
			),
			array(
				'elements' => '.rh_agent_expand_wrapper .rh_agent_list .rh_agent_agency .rh_property_agent__title',
				'property' => 'color',
				'value'    => get_option( 'inspiry_grid_card_2_bottom_agent_title', '#fff' ),
			),
			array(
				'elements' => '.rh_agent_expand_wrapper .rh_agent_list .rh_agent_agency .rh_property_agent__title:hover',
				'property' => 'color',
				'value'    => get_option( 'inspiry_grid_card_2_bottom_agent_hover_title', '#f7f7f7' ),
			),
			array(
				'elements' => '.rh_agent_expand_wrapper .rh_agent_list .rh_agent_agency .rh_property_agent__agency',
				'property' => 'color',
				'value'    => get_option( 'inspiry_grid_card_2_bottom_agency_title', '#fff' ),
			),
			array(
				'elements' => '.rh_agent_expand_wrapper .rh_agent_list .rh_agent_agency .rh_property_agent__agency:hover',
				'property' => 'color',
				'value'    => get_option( 'inspiry_grid_card_2_bottom_agency_hover_title', '#f7f7f7' ),
			),
			array(
				'elements' => '.rh_wrapper_bottom_agent .rh_agent_expand_wrapper',
				'property' => 'background',
				'value'    => get_option( 'inspiry_grid_card_3_bottom_agent_bg', '#f7f7f7' ),
			),
			array(
				'elements' => '.rh_wrapper_bottom_agent .rh_agent_expand_wrapper .rh_agent_list .rh_property_agent__title',
				'property' => 'color',
				'value'    => get_option( 'inspiry_grid_card_3_bottom_agent_title', '#1a1a1a' ),
			),
			array(
				'elements' => '.rh_wrapper_bottom_agent .rh_agent_expand_wrapper .rh_agent_list .rh_property_agent__title:hover',
				'property' => 'color',
				'value'    => get_option( 'inspiry_grid_card_3_bottom_agent_hover_title', '#1a1a1a' ),
			),
			array(
				'elements' => '.rh_wrapper_bottom_agent .rh_agent_expand_wrapper .rh_agent_list .rh_property_agent__agency',
				'property' => 'color',
				'value'    => get_option( 'inspiry_grid_card_3_bottom_agency_title', '#808080' ),
			),
			array(
				'elements' => '.rh_wrapper_bottom_agent .rh_agent_expand_wrapper .rh_agent_list .rh_property_agent__agency:hover',
				'property' => 'color',
				'value'    => get_option( 'inspiry_grid_card_3_bottom_agency_hover_title', '#1a1a1a' ),
			),
			array(
				'elements' => '.rh-grid-card-4 .rh-status-property-tag',
				'property' => 'background-color',
				'value'    => get_option( 'realhomes_grid_card_4_status_tag_bg_color', '#0b8278' ),
			),
			array(
				'elements' => '.rh-grid-card-4 .rh-status-property-tag',
				'property' => 'color',
				'value'    => get_option( 'realhomes_grid_card_4_status_tag_color', '#fff' ),
			),
			array(
				'elements' => '.rh-grid-card-4 .rh_prop_card__price',
				'property' => 'color',
				'value'    => get_option( 'realhomes_grid_card_4_price_color', '#fff' ),
			),
			array(
				'elements' => '.rh-grid-card-5 .rh-status-property-tag',
				'property' => 'background-color',
				'value'    => get_option( 'realhomes_grid_card_5_status_tag_bg_color', '#0b8278' ),
			),
			array(
				'elements' => '.rh-grid-card-5 .rh-status-property-tag',
				'property' => 'color',
				'value'    => get_option( 'realhomes_grid_card_5_status_tag_color', '#fff' ),
			),
			array(
				'elements' => '.rh-grid-card-5 .rh-property-title',
				'property' => 'color',
				'value'    => get_option( 'realhomes_grid_card_5_title_color', '#fff' ),
			),
			array(
				'elements' => '.rh-grid-card-5 .rh-property-price',
				'property' => 'color',
				'value'    => get_option( 'realhomes_grid_card_5_price_color', '#fff' ),
			),
			array(
				'elements' => '.rh-grid-card-5 .rh_prop_card_meta_theme_stylish .rh_prop_card__meta .figure',
				'property' => 'color',
				'value'    => get_option( 'realhomes_grid_card_5_meta_color', '#fff' ),
			),
			array(
				'elements' => '.rh-grid-card-5 .rh_prop_card_meta_theme_stylish .rh_prop_card__meta svg,
			...
			array(
				'elements' => '.rh_var2_header_meta_container .rh-btn, .rh_var2_header_meta_container .rh-btn-primary, .rh_var3_header .rh-btn-primary',
				'property' => 'border-color',
				'value'    => get_option( 'inspiry_submit_button_border_color' ),
			),
			array(
				'elements' => '.rh_var2_header_meta_container .rh-btn, .rh_var2_header_meta_container .rh-btn-primary:hover, .rh_var3_header .rh-btn-primary:hover',
				'property' => 'border-color',
			...
			array(
				...
				'property' => 'background',
				'value'    => get_option( 'inspiry_post_meta_bg' ),
			),
			array(
				'elements' => '.rh_blog__post .entry-header .entry-title a',
				'property' => 'color',
				'value'    => get_option( 'inspiry_post_title_color' ),
			),
			array(
				'elements' => '.rh_blog__post .entry-header .entry-title, .rh_blog__post .entry-header .entry-title a:hover',
				'property' => 'color',
				'value'    => get_option( 'inspiry_post_title_hover_color' ),
			),
			array(
