...
( function( $ ) {
    ...
    // Minimum Lot Size Search Placeholder
    wp.customize( 'realhomes_min_lot_size_placeholder_text', function( value ) {
        value.bind( function( to ) {
            $( '.rh_prop_search__option #min-lot-size' ).attr( "placeholder", to );
        } );
    } );

    // Maximum Lot Size Search Placeholder
    wp.customize( 'realhomes_max_lot_size_placeholder_text', function( value ) {
        value.bind( function( to ) {
            $( '.rh_prop_search__option #max-lot-size' ).attr( "placeholder", to );
        } );
    } );

    // Min Lot Size Label
    wp.customize( 'realhomes_min_lot_size_label', function( value ) {
        value.bind( function( to ) {
            $( '.rh_prop_search__option label[for="min-lot-size"] .label' ).text( to );
        } );
    } );

    // Max Lot Size Label
    wp.customize( 'realhomes_max_lot_size_label', function( value ) {
        value.bind( function( to ) {
            $( '.rh_prop_search__option label[for="max-lot-size"] .label' ).text( to );
        } );
    } );

    // Lot Size Unit Placeholder
    wp.customize( 'realhomes_lot_size_unit', function( value ) {
        value.bind( function( to ) {
            $( '.rh_prop_search__option label[for="min-lot-size"] .unit, .rh_prop_search__option label[for="max-lot-size"] .unit' ).text( "(" + to + ")" );
        } );
    } );
