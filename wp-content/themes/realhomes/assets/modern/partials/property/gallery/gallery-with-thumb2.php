	...
	<div class="property-detail-slider-three">
			...
			foreach ( $properties_images as $prop_image_id => $prop_image_meta ) {
				...
				if ( 'true' === $args['lightbox'] ) {
					echo '<a href="' . $prop_image_meta['full_url'] . '" data-fancybox="gallery" class="'.$args['class'].'" data-caption="' . $prop_image_meta['title'] . '">';
				} else {
					echo '<a href="' . $prop_image_meta['full_url'] . '" data-fancybox="gallery" class="'.$args['class'].'" >';
				}
