...
if ( inspiry_is_rvr_enabled() && 'true' === $price_details_display ) {
	...
	?>
	<div class="rvr_price_details_wrap single-property-section <?php realhomes_printable_section( 'rvr/price-details' ); ?>">
		<div class="container">
				...
				<?php
					...
					if ( ! empty( $bulk_prices ) ) {
						...
						foreach( $bulk_prices as $bulk_price ) {
						    if ( ! empty( $bulk_price['number_of_nights'] ) && $bulk_price['price_per_night'] ) {
							    ?>
