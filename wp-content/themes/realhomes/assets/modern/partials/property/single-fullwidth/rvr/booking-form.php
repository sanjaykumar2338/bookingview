...
if ( inspiry_is_rvr_enabled() && 'true' === $show_rvr_booking_form ) {
	?>
    <div class="rh_property__rvr_booking_section single-booking-section single-property-section">
        <div class="container">
                ...
                <form class="rvr-booking-form rh-booking-form-section" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
                    ...
                    <div class="booking-form-inner">
                        <div class="field-wrap three-col">
                            ...
                            <input id="rvr-user-name" type="text" class="form-control rh-mod-field" name="user_name" placeholder="<?php echo esc_attr( $name_placeholder ); ?>">
                        </div>

                        <div class="field-wrap three-col">
                            <div class="rh-mod-form-field">
                                <label for="rvr-email-"><?php echo esc_html( $email_label ); ?></label>
                                <input id="rvr-email-" type="text" name="email" class="form-control rh-mod-field required" placeholder="<?php echo esc_attr( $email_placeholder ); ?>" title="<?php echo esc_html( $email_error_message ); ?>">
                            </div>
                        </div>

                        <div class="field-wrap three-col">
                            <label for="rvr-phone-"><?php echo esc_html( $phone_label ); ?></label>
                            <input id="rvr-phone-" type="text" class="form-control rh-mod-field" placeholder="<?php echo esc_attr( $phone_placeholder ); ?>" name="phone">
                        </div>

                        <div class="field-wrap four-col">
                            <label for="rvr-check-in-booking"><?php echo esc_html( $checkin_label ); ?></label>
                            <input id="rvr-check-in-booking" type="text" name="check_in" class="form-control rh-mod-field rvr-check-in required" placeholder="<?php echo esc_attr( $checkin_placeholder ); ?>" title="<?php echo esc_html( $checkin_error_message ); ?>" autocomplete="off">
                        </div>

                        <div class="field-wrap four-col">
                            <label for="rvr-check-out-booking"><?php echo esc_html( $checkout_label ); ?></label>
                            <input id="rvr-check-out-booking" type="text" name="check_out" class="form-control rh-mod-field rvr-check-out required" placeholder="<?php echo esc_attr( $checkout_placeholder ); ?>" title="<?php echo esc_html( $checkout_error_message ); ?>" autocomplete="off">
                        </div>
                        ...
                        <div class="field-wrap six-col">
                            ...
                            <select id="rvr-adult-" name="adult" class="rvr-adult rh-mod-field inspiry_select_picker_trigger inspiry_bs_green show-tick">
					            <?php
                        ...
                        <div class="field-wrap six-col">
                            ...
                            <select id="rvr-child-" name="child" class="rvr-child rh-mod-field inspiry_select_picker_trigger inspiry_bs_green show-tick">
					            <?php
                        ...
                        <div class="field-wrap infants six-col">
                            ...
                            <select id="rvr-infant-" name="infant" class="rvr-infant rh-mod-field inspiry_select_picker_trigger inspiry_bs_green show-tick">
					            <?php
					            for ( $num = 0; $num <= $max_guests; $num += 1 ) {
						            echo "<option value='{$num}'>{$num}</option>";
					            }
                        ...
                        <div class="submission-area clearfix">
                            ...
                            <div class="rvr-booking-button-wrapper">
                                <input type="submit" value="<?php echo esc_html( $submit_label ); ?>" class="rvr-booking-button submit-button rh-btn rh-btn-primary rh_widget_form__submit">
                    ...
                    <div class="booking-cost">
                        ...
                        <div class="cost-field total-price-field">
                            <div class="cost-desc">
                                <strong><?php echo esc_html( $payable_label ); ?></strong>
                            </div>
