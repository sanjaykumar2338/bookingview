...
function display_agent_box( $args ) {
	...
	$youtube_url   = get_post_meta( $args['agent_id'], 'inspiry_youtube_url', true );
	$pinterest_url = get_post_meta( $args['agent_id'], 'inspiry_pinterest_url', true );
	$agent_website = get_post_meta( $args['agent_id'], 'REAL_HOMES_website', true );
                        ...
                        <div class="rh_property__agent_title_wrap">
							...
							<?php if ( ! isset( $args['display_author'] ) ) : ?>
                                <div class="listed_properties">
                                    ...
                                    <p class="number"><?php echo esc_html( $listed_properties ); ?></p>
                                </div>
							<?php endif; ?>
							...
							<?php if ( 'true' === $theme_display_agent_detail_page_link ) :
								...
								if ( isset( $args['display_author'] ) && $args['display_author'] ) :
									?>
                                    <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" class="rh_agent_card__link">
								...
								<?php
									...
									?>
                                    <a href="<?php echo esc_url( get_permalink( $args['agent_id'] ) ); ?>" class="rh_agent_card__link">
                                        <span><?php echo esc_html( $theme_agent_detail_page_link_text ); ?></span>
                                        <i class="fas fa-angle-right"></i>
                                    </a>
								<?php
