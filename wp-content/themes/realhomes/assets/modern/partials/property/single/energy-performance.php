...
if ( ! empty( $energy_class ) && '-1' != $energy_class && 'none' != $energy_class && 'true' == $epc_display ) {
	...
	?>
	<div id="property-content-section-energy-performance" class="property-content-section rh_property__energy_performance_wrap <?php realhomes_printable_section( 'energy-performance' ); ?>">
		<?php
