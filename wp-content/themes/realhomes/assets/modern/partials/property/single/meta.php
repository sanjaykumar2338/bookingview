...
<div class="rh_property__row rh_property__meta_wrap">
	...
	<?php if ( ! empty( $property_garage ) ) : ?>
        <div class="rh_property__meta prop_garages">
            ...
            <div>
				<?php realhomes_property_meta_icon( 'REAL_HOMES_property_garage',  '/images/icons/icon-garage.svg' ); ?>
                <span class="figure">
	...
	if ( inspiry_is_rvr_enabled() ) {
		if ( ! empty( $post_meta_data['rvr_guests_capacity'][0] ) ) : ?>
            <div class="rh_property__meta rvr_guest_capacity">
                ...
                <div>
					<?php
					realhomes_property_meta_icon( 'rvr_guests_capacity',  'images/guests-icons.svg', '/common/' );
					?>
		...
		if ( ! empty( $post_meta_data['rvr_min_stay'][0] ) ) : ?>
            <div class="rh_property__meta rvr_min_stay">
                ...
                <div>
					<?php realhomes_property_meta_icon( 'rvr_min_stay',  '/images/icons/icon-min-stay.svg' ); ?>
	...
	<?php if ( ! empty( $property_year_built ) ) : ?>
        <div class="rh_property__meta prop_year_built">
            ...
            <div>
				<?php realhomes_property_meta_icon( 'REAL_HOMES_property_year_built',  '/images/icons/icon-calendar.svg' ); ?>
                <span class="figure">
	...
	<?php if ( ! empty( $lot_size ) ) : ?>
        <div class="rh_property__meta prop_lot_size">
            ...
            <div>
				<?php realhomes_property_meta_icon( 'REAL_HOMES_property_lot_size',  '/images/icons/icon-lot.svg' ); ?>
                <span class="figure">
