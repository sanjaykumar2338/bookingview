        ...
        <div class="rh_property__agent_head">
            ...
            <div class="description">
				...
				if ( 'true' === $theme_display_agent_detail_page_link ) {
					...
					if ( isset( $args['display_author'] ) && ( $args['display_author'] ) ) { ?>
                        <a class="agent-single-page-link" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>">
							<?php echo esc_html( $theme_agent_detail_page_link_text ); ?>
                        </a>
						<?php
					} else { ?>
                        <a class="agent-single-page-link" href="<?php echo esc_url( get_permalink( $args['agent_id'] ) ); ?>">
							<?php echo esc_html( $theme_agent_detail_page_link_text ); ?>
                        </a>
						<?php
					}
				...
				if ( inspiry_get_agent_custom_form( $args['agent_id'] ) ) {
                    ...
                    <form id="<?php echo esc_attr( $agent_form_id ); ?>" class="agent-form contact-form-small" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
                        ...
                        <div class="rh_agent_form__field rh_agent_form__textarea">
                            ...
                            <textarea rows="6" name="message" id="comment-<?php echo esc_attr( $agent_form_id ); ?>" class="required" placeholder="<?php esc_attr_e( 'Your Message', 'framework' ); ?>" title="<?php esc_attr_e( '* Please provide your message', 'framework' ); ?>"><?php
...
<div id="rh_property__agents_wrap" class="rh_property__agents_wrap">
    <h4 class="rh_property__heading rh_property__heading-agents"><?php esc_html_e( 'Agents', 'framework' ); ?></h4>
