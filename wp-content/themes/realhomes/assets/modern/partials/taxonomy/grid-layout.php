...
?>
<section class="rh_section rh_section--flex rh_wrap--padding rh_wrap--topPadding <?php echo esc_attr( $ajax_class ); ?>">
	<?php
    ...
    <div class="rh_page rh_page__listing_page rh_page__main">
        ...
        <div class="rh_page__listing rh_page__listing_grid <?php printf( 'rh-grid-%s-columns', esc_attr( get_option( 'realhomes_grid_template_column', '2' ) ) ); ?>">
			...
			if ( $taxonomy_query->have_posts() ) :
				...
				realhomes_print_no_result( '', array( 'container_class' => 'rh_alert-wrapper' ) );
			endif;
			?>
