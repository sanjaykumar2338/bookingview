					...
					if ( $theme_cpt_cfoss == 'slide' ) {
								...
								if ( $image_id ) {
                                    ...
                                    <li>
										<?php if ( ! empty( $slide_url ) ) : ?>
                                            <a class="slide" href="<?php echo ( ! empty( $slide_url ) ) ? esc_url( $slide_url ) : '#'; ?>" style="background: url('<?php echo esc_url( $slider_image_url ); ?>') 50% 50% no-repeat; background-size: cover;"></a>
										<?php else : ?>
                                            <div class="slide" style="background: url('<?php echo esc_url( $slider_image_url ); ?>') 50% 50% no-repeat; background-size: cover;"></div>
										<?php endif; ?>
                                        <div class="rh_slide__desc cfos_slide_visible_sm">
											<?php if ( ! empty( $slide_title ) || ! empty( $slide_sub_text ) ) : ?>
                                                <div class="rh_slide__desc_wrap">
													...
													<?php else : ?><?php the_title( '<h3>', '</h3>' ); ?><?php endif; ?>
                        ...
                        <ul class="slides">
							...
							while ( $slider_query->have_posts() ) :
								...
								$size_postfix       = realhomes_get_area_unit( $slide_id );
								...
								if ( $slider_image_id ) {
                                    ...
                                    <li>
                                        <a class="slide" href="<?php the_permalink(); ?>" style="background: url('<?php echo esc_url( $slider_image_url ); ?>') 50% 50% no-repeat;background-size: cover;"></a>
                                        <div class="rh_slide__desc cfos_slide_visible_sm">
                                            <div class="rh_slide__desc_wrap">
