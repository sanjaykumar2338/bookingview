...
if ( inspiry_is_search_fields_configured() ) :
	...
	?>
    <form class="rh_prop_search__form rh_prop_search_form_header advance-search-form <?php echo esc_attr( $form_classes ); ?>" action="<?php echo esc_url( inspiry_get_search_page_url() ); ?>" method="get">
