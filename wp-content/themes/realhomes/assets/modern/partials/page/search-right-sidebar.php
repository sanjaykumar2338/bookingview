...
<section id="properties-listing" class="rh_section rh_section--flex rh_wrap--padding rh_wrap--topPadding <?php echo sanitize_html_class( $ajax_search_class ) . ' ' . sanitize_html_class( $ajax_class ); ?>">
	<?php
