				...
				if ( ! empty( $field['id'] ) && ! empty( $field['name'] ) ) {
                    ...
                    <div class="form-option">
						...
						if ( ! empty( $field['type'] ) && $field['type'] == 'select' && ! empty( $field['options'] ) && is_array( $field['options'] ) ) {
							...
							?>
                            <input type="checkbox" class="rh_classic_input_cb" id="<?php echo esc_attr( $field['id'] ); ?>" name="<?php echo esc_attr( $field['id'] ); ?>" value="<?php echo esc_attr( $field['std'] ); ?>">
                            <label class="rh_classic_label_cb" for="<?php echo esc_attr( $field['id'] ); ?>"><span><?php echo esc_attr( $field['title'] ); ?></span></label>
							<?php
						} else {
							?>
                            <input
