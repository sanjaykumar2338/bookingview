	...
	if ( is_user_logged_in() ) {
        ...
        <div class="rh-ultra-menu-user-profile">
			...
			if ( isset( $current_user_meta['profile_image_id'] ) && ! empty( $current_user_meta['profile_image_id'][0] ) ) {
				$profile_image = wp_get_attachment_image( $current_user_meta['profile_image_id'][0], array(
					'48',
					'48'
				), "", array( "class" => "rh-user-account-profile-img" ) );
			...
			// modal login.
			get_template_part( 'assets/ultra/partials/header/modal' );
			?>
