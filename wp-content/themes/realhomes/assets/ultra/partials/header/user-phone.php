...
if ( ! empty( $header_phone ) ) {
    ...
    <div class="rh-ultra-user-phone">
		<?php inspiry_safe_include_svg( '/icons/' . $header_phone_icon . '.svg' ); ?>
		...
		?>
        <a target="_blank" href="<?php echo esc_url( $phone_click ); ?>" class="contact-number"><?php echo esc_html( $header_phone ); ?></a>
    </div>
	<?php
}
?>