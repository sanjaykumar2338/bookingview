...
?>
<section id="properties-listing" class="rh-page-container container rh-ultra-grid-listing <?php echo esc_attr( $ajax_class ) ?>" data-properties-count="<?php echo esc_attr( $number_of_properties ); ?>">
    <div class="row">
        <div class="rh-ultra-page-content">
			<?php
			// Display any contents after the page banner and before the contents.
			do_action( 'realhomes_before_page_contents' );
			?>
