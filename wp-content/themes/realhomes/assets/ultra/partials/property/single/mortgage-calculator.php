        ...
        <div class="rh_property__mc clearfix">
            ...
            <div class="mc_right_side <?php echo 'graph_' . esc_attr( $graph_type ); ?>">
				...
				if ( 'true' !== $hoa_field_display ) {
					...
					$hoa_field_label = get_option( 'inspiry_mc_second_field_title', esc_html__( 'Other Dues', 'framework' ) );
				}
				...
				if ( 'circle' === $graph_type ) {
                    ...
                    <div class="mc_term_interest">
                        <div class="rh-mc-label-box">
							...
							<?php esc_html_e( 'Years Fixed', 'framework' ); ?>
                            </span>
                        </div>
                        <div class="rh-mc-label-box">
                    ...
                    <div class="mc_term_interest">
                        <span class="mc_term_value"><?php echo esc_html( $mc_default['term'] ); ?></span> <?php esc_html_e( 'Years Fixed', 'framework' ); ?>
                        ,
                    ...
                    <ul>
						...
						if ( ! empty( $mc_default['tax'] ) ) {
                            ...
                            <li class="mc_cost_tax"><?php echo esc_html( $tax_field_label ); ?>
                                <span><?php echo esc_html( ere_format_amount( $mc_default['tax'] ) ); ?></span></li>
							<?php
						}
						...
						if ( ! empty( $mc_default['fee'] ) ) {
                            ...
                            <li class="mc_cost_hoa"><?php echo esc_html( $hoa_field_label ); ?>
                                <span><?php echo esc_html( ere_format_amount( $mc_default['fee'] ) ); ?></span></li>
							<?php
						}
						?>
                    </ul>
